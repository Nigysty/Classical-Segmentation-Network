...
class CAB(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.global_pooling = nn.AdaptiveAvgPool2d(1)  # H，W = 1，1
        self.conv1 = nn.Conv2d(in_channels, out_channels, kernel_size=1, stride=1, padding=0)
        self.relu = nn.ReLU()
...
class DFN(nn.Module):
    def __init__(self, num_class=21):
        ...
        self.layer1 = nn.Sequential(resnet101.maxpool, resnet101.layer1) # layer1 = pool + Res1
        ...
        # CAB的in_channels由两个部分组成，各部分channels = num_class
        
        # Smooth Network 左边的RRB
    ...
    def forward(self, x):
        ...
        # for border network ; res1只是Border Network最终的RRB输出
        ...
        # for smooth network ； Res2 ： Smooth Network最终输出的RRB
